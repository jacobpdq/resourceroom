...
<?php /*
	<h1 class="fes-headers" id="fes-delete-product-page-title"><?php echo __( 'Delete', 'edd_fes' ) . ' ' . EDD_FES()->vendors->get_product_constant_name( $plural = false, $uppercase = true )  .  ' ' . __('#: ','edd_fes'); echo $post_id; ?></h1>
*/ ?>
	<p><?php echo __( 'Are you sure you want to delete this', 'edd_fes') . ' ' . EDD_FES()->vendors->get_product_constant_name( $plural = false, $uppercase = false )  .  __('? This action is irreversible.', 'edd_fes' ); ?></p>
