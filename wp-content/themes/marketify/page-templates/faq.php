          ...
          <div class="row">
            <div class="col-md-3">
              <ul class="sidenav small">
                ...
                <li><a href="<?php echo $siteurl ?>/faq/#profits">What’s this about 10% of profits supporting Canadian education?</a></li>
                <li><a href="<?php echo $siteurl ?>/faq/#submitproject">How can I submit a project proposal to receive funding from Resource Room?
</a></li>
                <li><a href="<?php echo $siteurl ?>/faq/#whichbrowser">Which browser should I use for Resource Room?</a></li>
                <li><a href="<?php echo $siteurl ?>/faq/#whatisroom">What is a Room?</a></li>
                ...
                <li><a href="<?php echo $siteurl ?>/faq/#resourceviolate">I have found a resource that violates copyright law, what should I do?</a></li>
                <li><a href="<?php echo $siteurl ?>/faq/#resourceoffensive">I find a resource on Resource Room to be offensive or harmful, what should I do?</a></li>
                ...
                <li><a href="<?php echo $siteurl ?>/faq/#howbuyresource">How do I buy a resource?</a></li>
                ...
                <li><a href="<?php echo $siteurl ?>/faq/#howaccessresource">How can I access my purchased resources?</a></li>
                ...
                <li><a href="<?php echo $siteurl ?>/faq/#recordresourcesales">Is there a record of my resource sales?</a></li>
                <li><a href="<?php echo $siteurl ?>/faq/#resourceinviolation">I am afraid that my resource is in violation of copyright, what should I do?</a></li>
              </ul>
            </div>
            <div class="col-md-7">
				<h3>General</h3>
				...
				<div id="whichbrowser">
					<p class="faq-question">Which browser should I use for Resource Room?</p>
					<p>Chrome, Internet Explorer, Firefox, Opera, and Safari are all supported browsers that will help you access all of our features. Please be sure to enable cookies and JavaScript. We recommend having the latest version of your browser of choice - having an outdated browser is unsafe and can interfere with website functionality. Find the latest versions of the major browsers <a href="http://browsehappy.com/">here</a>.</p>
				</div>
			  
				<div id="whatisroom"> 
					<p class="faq-question">What is a Store?</p>
					<p>Resource Room allows all teachers to create their own personal profiles, called Rooms. Your Room can be used to organize and promote the resources that you are selling. Here, you can introduce yourself to our Resource Room community by sharing a little bit about your teaching background and personal pedagogy.</p>
					<p>Your Room displays all the resources that you are sharing with the Resource Room community. </p>
				</div>
			  
				<div id="whatishomeroom"> 
					<p class="faq-question">What is a Homeroom?</p>
					<p>Your Homeroom is the place where you can view and control all your activity on Resource Room. Your Homeroom provides access to your Sales Log (a list of your sales and transaction records), Payroll (a record of receipts for your earnings), Reviews and Ratings (tracking user feedback on your resources), Uploads, and Notifications. The Homeroom also provides easy access for uploading new resources, and editing or removing current resources.</p>
				</div>
				...
				<div id="doyoufree">
					<p class="faq-question">Do you ever offer free resources?</p>
				...
				<div id="resourceviolate">
					<p class="faq-question">I have found a resource that violates copyright law, what should I do?</p>
					<p>If you believe that any resources on our site violates copyright laws, please report the item by clicking the "Report" link underneath the Resource's description, or contact us at <a href="mailto:admin@resourceroom.ca">admin@resourceroom.ca</a>. We take this very seriously and will promptly investigate and remove any items that violate copyright and other laws. Thank you for taking the time to notify us of these issues - your involvement makes Resource Room a stronger tool for Canadian educators.  </p>
				</div>
				
				<div id="resourceoffensive">
					<p class="faq-question">I find a resource on Resource Room to be offensive or harmful, what should I do?</p>
					<p>If you come across a resource that is offensive or harmful please report the item by clicking the "Report" link underneath the Resource's description, or contact us at <a href="mailto:admin@resourceroom.ca">admin@resourceroom.ca</a>. We take this very seriously and want to make sure that our site does not promote or distribute offensive or harmful products. Thank you for taking the time to notify us of these issues - your involvement makes Resource Room a stronger tool for Canadian educators. </p>
				</div>
				
				<div id="outsidecanada">
					<p class="faq-question">I live outside of Canada: Can I still use Resource Room?</p>
				...
				<div id="howbuyresource">
					...
					<p>After you have found a resource that you'd like to buy, click the Purchase button on the item listing. Resource Room accepts credit cards and Paypal transactions. Once you select your desired method of payment, follow the instructions given.  If you have selected a Free resource, you will not be charged! </p>
				</div>
				
				<div id="whatwithcredit">
					<p class="faq-question">What do you do with my credit card information?</p>
					<p>Resource Room does not have access to your credit card information. Your credit card information is handled by Paypal. </p>
				</div>
				
				<div id="howaccessresource">
					<p class="faq-question">How can I access my purchased resources?</p>
					<p> Your purchased resources can by clicking "Purchase History" in the dropdown menu in the top right corner of the page. From here, you can download and print your resources. Resources will be stored for an indefinite amount of time. </p>
				</div>
				
				<div id="whatrefundpolicy">
					<p class="faq-question">What is your refund policy?</p>
			...
			<div id="howuploadproduct">
				...
				<ol>
					...
					<li>You may use the following methods to access the Upload Form:
                      <ol class="ol-sub">
					...
					<li>Enter the price that you would like to charge for your resource. Remember, you can offer resources for free if you'd like - just put 0 in the price field. Sharing is caring!</li>
			...
			<div id="howmanageresource">
				<p class="faq-question">How do I manage my resources?</p>
				<p>You can see all of your previously added resources in your Room and in your Homeroom. Your Homeroom offers the greatest options in managing your resources. By clicking on "My Uploads" you can see the status, number of views, and number of purchases of each resource. On the right hand side of the page, you can access Edit and Delete buttons. </p>
			 </div>
			 
			 <div id="howgetpaid">
				<p class="faq-question">How do I get paid?</p>
               ...
               <p>*PayPal is a fast and safe way to get paid online. Sign up for a PayPal account by clicking <a href="http://www.paypal.com">here</a>.</p>
			...
			<div id="recordresourcesales">
				<p class="faq-question">Is there a record of my resource sales?</p>
			...
			<div id="resourceinviolation">
				<p class="faq-question">I am afraid that my resource is in violation of copyright, what should I do?</p>
				...
				<p>In Canada, copyright is protected through the federal government's <a href="http://laws-lois.justice.gc.ca/eng/acts/C-42/FullText.html">Copyright Act</a>. Please familiarize yourself with Canada's Copyright Act before uploading content to Resource Room. </p>
				<p>The Council of Ministers of Education, Canada has created a document called <a href="http://cmec.ca/Publications/Lists/Publications/Attachments/291/Copyright_Matters.pdf">Copyright Matters!</a>, which provides the education community with user-friendly information on copyright law. This document will help clarify common questions related to copyright law and education. </p>
