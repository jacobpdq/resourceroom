        ...
        <div class="card-white double-padding">
          ...
          <div class="row">
            ...
            <div class="col-md-7">
              ...
              <p>Resource Room is a resource hub made with Canadian teachers in mind. Get access to a database of peer created and reviewed classroom resources, high quality resources offered by Canadian organizations, and current news and content for your continued professional development. Our aim is to provide a single location for you to conveniently source high quality, relevant, and current educational resources based on Canadian education and provincial curriculum expectations. </p>
              
              <p>We hope that increased collaboration among Canadian teachers will benefit our system and our students. As a commitment to the betterment of Canadian education, Resource Room will donate 10% of quarterly profits to programs and projects that support Canadian education. Visit our FAQ to see how you can apply for a donation!</p>
              
              <h3 id="mission">Mission</h3>
              <p>Our mission is to create a useful tool for Canadian teachers in order to support educational practices in Canadian classrooms. With improved opportunities for sharing and collaboration, less time will be spent recreating the wheel and teachers will be able to tackle the important stuff – differentiation, accommodation, and attention to diverse student needs. We hope to support teachers by freeing up their time and allowing them to focus their energy and passion on the things that matter most: students and school communities. </p>
              <p>Furthermore, we commit to supporting Canadian teachers by funding programs and projects that support Canadian education. </p>
              ...
              <p>We opt for <em>relevance</em>. In Canada, our educational system is provincially regulated. That means Grade 5 Social Studies in British Columbia We opt for relevance. In Canada, our educational system is provincially regulated. That means Grade 5 Social Studies in British Columbia is not necessarily the same as Grade 5 Social Studies in Ontario. We offer an organized marketplace, created specifically for Canadian teachers, with provincial curriculum in mind. When you search for resources, we want you to be assured that they meet requirements and can be successfully applied in your classroom.</p>
              <p>We choose <em>quality over quantity</em>. By limiting our marketplace to Canadian teachers, we narrow the buying and selling community. The Resource Room is a marketplace of high quality resources that are used in real Canadian classrooms. To monitor the quality of resources available in our marketplace, we use a peer review system, which allows teachers to rate and review resources. Low-quality resources can be flagged and reported and together we can ensure that our community is top notch.</p>
              <p>We urge educators to <em>keep with the times</em>. Print resources risk becoming outdated and irrelevant too quickly. Our digital database provides an opportunity for the most current and relevant resources to be shared. Keeping up with new research, best practices, and current classroom technology is increasingly important and we help make it accessible!</p>
              <p>We support <em>Canadian education</em>. Beyond creating a platform for resource sharing and up to date Canadian educational content, we put our money where our mouth is by donating 10% of quarterly profits to programs and projects that benefit Canadian education. We are Canadian and are invested in the success of Canadian education.</p>
              
              <h3 id="how-it-works">How it Works</h3>
              <h4>Buying</h4>
              <p>Sign up to become a member → Provide PayPal information to make regular purchases easy and safe (optional) → Browse resources → Read user reviews → Purchase → Download your resource and enjoy! (Resources will be held in your personal account where they can be accessed and printed) </p>
              <h4>Selling</h4>
